...
$sourceDir = Join-Path $root 'src\assets\product-flanges'
$outputDir = Join-Path $root 'src\assets\product-flanges-normalized'
...
$files = @(
  ...
  'flange-solto.png',
  'flange-liso.png',
  'orificio-pescoco.png',
  'orificio-slip-on.png',
  'orificio-roscado.png',
  'flange-de-reducao.png'
)
